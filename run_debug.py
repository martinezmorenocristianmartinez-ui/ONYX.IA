...
def main():
    ...
    print("   Cualquier cambio en el código reiniciará ONYX automáticamente.")
    print("============================================================")
    ...
    try:
        ...
        while True:
            ...
            if child.poll() is not None:
                ...
                if exit_code == 0:
                    print("\033[1;33m[RELOADER] ONYX cerró normalmente.\033[0m")
                else:
                    print(f"\033[1;31m[RELOADER] ONYX finalizó con código de error {exit_code}. Esperando cambios para reiniciar...\033[0m")
