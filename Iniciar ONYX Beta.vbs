' ONYX — Lanzador con permisos de Administrador
...
End If
If Not fso.FileExists(py) Then
    MsgBox "ONYX: ejecuta el archivo Instalar_ONYX.bat primero para configurar el entorno.", 16, "ONYX"
    WScript.Quit 1
End If
